...
export default function TvShows() {
  ...
  if (loading) {
    return (
      <View style={styles.center}>
        ...
        <Text style={{ marginTop: 10, color: "#fff" }}>Loading TV shows...</Text>
      </View>
    );
  }
  ...
  if (error) {
    return (
      <View style={styles.center}>
        <Text style={{ color: ACCENT }}>Failed to load TV shows.</Text>
      </View>
    );
  }
          ...
          >
            ...
            >
              ...
              <Animated.Image
                ...
                source={{
                  uri: `https://image.tmdb.org/t/p/w500${selectedShow.poster_path}`,
                }}
                style={[
                  styles.largePoster,
                  {
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.infoText}>{selectedShow.overview}</Text>
                </Animated.View>
              </Animated.View>
            </Pressable>
          </Pressable>
